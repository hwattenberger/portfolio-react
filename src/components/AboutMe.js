            ...
            <div className="md:w-6/12 bg-purple-100 p-4 m-4 rounded">
                ...
                <div className="p-2">
                    ...
                    <div className="box-border w-full flex flex-wrap">
                        ...
                        <span className="bg-blue-300 m-1 px-2 py-1 rounded" key={area}>
                            {area}
                        </span>
                        ))}
                    </div>
                ...
                <div className="p-2">
                    ...
                    <div className="box-border w-full flex flex-wrap">
                        ...
                        <span className="bg-purple-400 m-1 px-2 py-1 rounded" key={area}>
                            {area}
                        </span>
                        ))}
                    </div>
                ...
                <h2 className="text-3xl p-2">Contact Me</h2>
                <p className="p-2">Please email me at hwattenberger@gmail.com</p>
          </div>
        </>
    )
}
